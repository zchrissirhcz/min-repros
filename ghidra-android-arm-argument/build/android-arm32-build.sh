...
#ANDROID_NDK=~/soft/android-ndk-r21e # ok
#ANDROID_NDK=~/soft/android-ndk-r15c # wrong
#ANDROID_NDK=~/soft/android-ndk-r16b # wrong
#ANDROID_NDK=~/soft/android-ndk-r19c # wrong
ANDROID_NDK=~/soft/android-ndk-r22b # wrong
